...
import numpy as np
from .model_anim_datagen import ModelAnimDataGenerator
...
class ModelSimulator():
    ...
    def setup_canvas(self):
        ...
        self.infeclbltext = self.sim_ax.text(0.96, infec_val*0.5, 
                                             ...
                                             fontweight='heavy', fontsize=15*infec_val)
        ...
        self.succeclbltext = self.sim_ax.text(0.955, infec_val+succep_val*0.5, 
                                               ...
                                               transform=self.sim_ax.transAxes, color='w',
                                               fontweight='heavy', fontsize=15*succep_val)
        ...
        self.recovlbltext = self.sim_ax.text(0.955,1 - 0.5*recov_val - 0.04, 
                                            ...
                                            fontweight='heavy', fontsize=15*recov_val)
    ...
    def update_canvas(self, i):
        ...
        self.infeclbltext.set_size(15*infec_pct_lst)
        ...
        self.succeclbltext.set_size(15*succep_pct_lst)
        ...
        self.recovlbltext.set_size(25*remov_pct_lst)
